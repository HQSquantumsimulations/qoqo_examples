...
pub fn deutsch_josza_main() {
    ...
    fn checking_constant(res: &[bool]) -> bool {
        return res.iter().all(|&el| el == false);
    }
    ...
    // For the balanced oracle the interference suppresses the amplitue of the $|00\rangle$ state.
